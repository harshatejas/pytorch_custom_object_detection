...
filename = "IMG_2609.JPG"    # Image filename
img_path = "dataset/validation/" + filename
...
data = pd.read_csv('dataset/ground_truth.csv')
label_boxes = data[data["filename"] == filename][["xmin", "ymin", "xmax", "ymax"]].values
